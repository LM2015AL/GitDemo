...
public class MainWindow {
	...
	public static final String SRC = RESOURCES_PATH + "zqzr.pdf";
	public static final String DEST = RESOURCES_PATH + "signed_zqzr.pdf";
	public static final String SIGN = RESOURCES_PATH + "gongzhang.png";
